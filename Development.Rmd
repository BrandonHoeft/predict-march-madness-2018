...
set.seed(321)
regularization_fit <- train(x = as.matrix(modeling_dataset[, -c(1:2)]),
                 y = modeling_dataset$outcome,
                 method = 'glmnet',
                 trControl = training_setup,
                 metric = "ROC",
...
regularization_fit
regularization_fit$bestTune
plot(regularization_fit)
# save model.
LASSO_final_fit <- regularization_fit$finalModel
#coef(regularization_fit$finalModel)

# model saved on 3/13/18 at 8:07pm
s3save(LASSO_final_fit, bucket = "ncaabasketball", object = "LASSO_final_fit.Rdata")
#s3load(object = "LASSO_final_fit.Rdata", bucket = "ncaabasketball")
#str(LASSO_final_fit)
# names(LASSO_final_fit$trainingData)
```
