...
``` {r}
#stage1_test_data <- head_to_head_matchup_stats %>%
...
modeling_dataset <- head_to_head_matchup_stats %>%
    ...
    filter(complete.cases(.),
           Season %in% 2003:2013, 
           DayNum > quantile(RegularSeasonDetailedResults_Prelim2018$DayNum, .10)) %>%
    ...
    select(-tournament_type, -tournament_type_OPP, -Team_conf, -Team_conf_OPP)
