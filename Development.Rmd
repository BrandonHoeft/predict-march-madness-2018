...
I will focus on LASSO and Ridge regression primarily. 
...
ridge_lasso_tune_grid <- expand.grid(alpha = 0:1,
  lambda = seq(0.0001, 1, length = 10))


set.seed(321)
regularization_fit <- train(x = modeling_dataset[, -c(1:2)],
                 y = modeling_dataset$outcome,
                 method = 'glmnet',
                 trControl = training_setup,
                 metric = "ROC",
...
regularization_fit
varImpPlot(regularization_fit$finalModel)
